...
- **Donations and Disbursements are independent, immutable, append-only records.** "Donation is the reverse of Disbursement" describes their structural relationship (money in vs. money out), not a linkage between specific entries — there is no reversal/offsetting mechanism to build.
